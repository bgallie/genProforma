...
// rotors and permutators) using Go's
// cyrpt/rand package or by using a key and Go's math/rand package.  Proforma
// machines generated by a secret key will be identical to proforma machines
// generated with the same secret key.
